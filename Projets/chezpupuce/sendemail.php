<?php
    ...
    $to         = 'gplcom@yahoo.es';  // ecrire email 
    ...
    if ( mail( $to, $subject, $contents, $headers ) ) {
        $result = array( 'response' => 'success', 'message'=>'Nous Vous remercions pour avoir envoyé ce courriel.' );
    } else {
        $result = array( 'response' => 'error', 'message'=>'Il est impossible de vérifier votre envoi.'  );
    }
    echo json_encode( $result );
    die;
