	...
	<body>
		...
		<div class="borders">
			...
			<div class="votreReponse">
				...
				<div class="row">
					<div class="col-md-1 col-sm-3">1</div>
					<div class="col-md-6 offset-md-1 col-sm-9">6</div>
					<div class="col-md-2 offset-md-2 col-sm-12">2</div>
				</div>
			</div>
		</div>
			...
			<div class="votreReponse">
				...
				<div class="row">
					<div class="col-3 offset-1">
						<div class="row">
							<div class="col-4 offset-4">Niv 3</div>
							<div class="col-4">Niv 3</div>
						</div>
					</div>
				</div>
				<div>&nbsp;</div>
				<div class="row">
					<div class="col-6 offset-5">Niv2</div>
				</div>
			</div>
		</div>
		...
		<div class="borders">
			...
			<div class="votreReponse">
				...
				<div class="row">
					<div class="col-lg-12 d-lg-block d-sm-none">2</div>
				</div>
				<div class="row">
					<div class="col-lg-12 d-lg-none d-block">3</div>
				</div>
				<div class="row">
					<div class="col-lg-12 d-none d-sm-block">4</div>
				</div>
				<div class="row">
					<div class="col-lg-12 d-sm-none ">5</div>
				</div>
